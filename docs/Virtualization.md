...
- [Virtualization](#virtualization)
  ...
  - [Virtual Machines](#virtual-machines)
    - [Install Proxmox](#install-proxmox)
      ...
      - [Storage layout (use both SSD + HDD)](#storage-layout-use-both-ssd--hdd)
...
#### Storage layout (use both SSD + HDD)
...
(Find the VM’s IP in Proxmox summary once the guest agent is running, or via `ip a` in the VM shell.)
